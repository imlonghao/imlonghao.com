/* PrismJS 1.15.0
https://prismjs.com/download.html#themes=prism-coy&languages=markup+css+clike+javascript+bash+markup-templating+go+json+nginx+php+sql+python&plugins=line-numbers */
var _self =
